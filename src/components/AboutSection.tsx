  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="absolute bottom-20 left-20 w-[500px] h-[500px] bg-[#4AA3FF] rounded-full mix-blend-screen filter blur-3xl opacity-15 animate-pulse"
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          <div className="relative order-1 lg:order-2">
            ...
            <div
              className="absolute -top-10 -right-10 w-40 md:w-48 h-40 md:h-48 bg-gradient-to-br from-[#4AA3FF] to-[#5BB4FF] rounded-full opacity-25 blur-3xl animate-pulse"
