  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#050B14] via-[#0A1628] to-[#0F2847]">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        ...
        ></div>
        <div
          className="absolute top-1/2 left-1/2 w-[600px] h-[600px] bg-[#5BB4FF] rounded-full mix-blend-screen filter blur-3xl opacity-15 animate-pulse"
            ...
            <div className="md:hidden bg-gradient-to-br from-[#0B1D3F] to-[#0A1628] border-t border-[#4AA3FF]/20 shadow-lg">
              <nav className="flex flex-col space-y-1 py-4">
                <button
                  ...
                  className="text-white/90 hover:text-white hover:bg-[#4AA3FF]/10 transition-all text-left px-4 py-3 rounded-lg"
                >
                  Home
                </button>
                <button
            ...
            >
              ...
              <div className="p-5 md:p-6 relative z-10">
                <h3 className="text-white mb-2 flex items-center justify-between text-base md:text-lg">
                  ...
                  <ExternalLink
                    className="text-[#4AA3FF] opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0"
                    size={18}
                  />
                </h3>
