    ...
    <footer className="bg-gradient-to-b from-[#0A1628] to-[#050B14] border-t border-[#4AA3FF]/10">
      <div className="container mx-auto px-4 lg:px-8 py-8 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-6 md:mb-8">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-white mb-4 text-base md:text-lg">
              Quick Links
            </h4>
            <ul className="space-y-2">
              <li>
                <a
                  href="#"
                  className="text-white/70 hover:text-[#4AA3FF] transition-colors text-sm md:text-base"
                >
                  Privacy Policy
                </a>
              </li>
          ...
          <div>
            ...
            <div className="flex space-x-3 md:space-x-4">
              ...
              <a
                href="https://www.instagram.com/kickoffmediaofficial?igsh=MTBpenF2YWZ1Z3NueA%3D%3D&utm_source=qr "
                target="_blank"
                className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#0F6EEA]/10 to-[#4AA3FF]/10 border border-[#4AA3FF]/20 hover:bg-gradient-to-br hover:from-[#0F6EEA] hover:to-[#4AA3FF] hover:border-transparent flex items-center justify-center transition-all"
              >
              ...
              <a
                href="https://www.facebook.com/share/1D4AEHUU1q/?mibextid=wwXIfr "
                target="_blank"
                className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#0F6EEA]/10 to-[#4AA3FF]/10 border border-[#4AA3FF]/20 hover:bg-gradient-to-br hover:from-[#0F6EEA] hover:to-[#4AA3FF] hover:border-transparent flex items-center justify-center transition-all"
              >
