...
export function HeroSection() {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#050B14] via-[#0A1628] to-[#0F2847]"
    >
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="absolute top-40 right-10 w-[500px] h-[500px] bg-[#4AA3FF] rounded-full mix-blend-screen filter blur-3xl opacity-20 animate-pulse"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute -bottom-20 left-1/2 w-[500px] h-[500px] bg-[#5BB4FF] rounded-full mix-blend-screen filter blur-3xl opacity-20 animate-pulse"
      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-8 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative lg:h-[500px] h-[400px] order-1 lg:order-2">
            ...
            <div
              className="absolute -bottom-16 -right-16 w-52 h-52 bg-gradient-to-br from-[#4AA3FF] to-[#5BB4FF] rounded-full opacity-30 blur-3xl animate-pulse"
              style={{ animationDelay: "1s" }}
            ></div>
          </div>
