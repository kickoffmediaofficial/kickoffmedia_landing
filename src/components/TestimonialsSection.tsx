...
const testimonials = [
  ...
  },
  {
    ...
    image: logo2,
    quote:
      "Working with KickOff Media has been a game-changer for our e-commerce business. Their data-driven strategies helped us double our online sales in just 6 months.",
    rating: 5,
  },
  {
    ...
    image: logo3,
    quote:
      "The team at KickOff Media truly understands modern marketing. Their creative campaigns and technical expertise helped us reach new markets we never thought possible.",
    rating: 5,
  },
  {
    ...
    image: logo4,
    quote:
      "Exceptional service and results! KickOff Media helped us build a strong online community and significantly increased our patient engagement rates.",
    rating: 5,
  },
];
                ...
                <Card className="bg-gradient-to-br from-[#0F6EEA]/10 to-[#4AA3FF]/5 backdrop-blur-sm border-[#4AA3FF]/30 p-6 md:p-8 h-full hover:border-[#4AA3FF]/50 transition-all">
                  <div className="flex items-center mb-4 md:mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-[#4AA3FF] text-xs md:text-sm">
                  ...
                  <div className="flex mb-3 md:mb-4">
                    {[...Array(testimonial.rating)].map((_, i) => (
                      <Star
                        key={i}
                        className="text-[#4AA3FF] fill-[#4AA3FF]"
                        size={18}
                      />
                    ))}
                  </div>
